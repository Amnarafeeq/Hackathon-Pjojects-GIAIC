...
function addNewCourseField(): void {
  ...
  newCourseNode.setAttribute(
    "placeholder",
    "e.g., Web Development Bootcamp, Codecademy"
  );
...
function addNewSkillField(): void {
  ...
  newSkillNode.setAttribute(
    "placeholder",
    "e.g., JavaScript, React, Python, Project Management"
  );
...
function genResume(event: Event) {
  ...
  (
    document.getElementById("user-address") as HTMLElement
  ).innerHTML = `<i class="fas fa-map-marker-alt"></i> ${
    (document.getElementById("addressField") as HTMLInputElement).value
  }`;
  (
  ...
  (
    document.getElementById("user-linkedin") as HTMLElement
  ).innerHTML = `<i class="fa-brands fa-linkedin"></i> ${
    (document.getElementById("linkField") as HTMLInputElement).value
  }`;
  (
    document.getElementById("user-github") as HTMLElement
  ).innerHTML = `<i class="fa-brands fa-github"></i> ${
    (document.getElementById("gitField") as HTMLInputElement).value
  }`;

  (document.getElementById("user-profession") as HTMLElement).innerHTML = (
    document.getElementById("professionField") as HTMLInputElement
  ).value;
  (document.getElementById("user-profile") as HTMLElement).innerHTML = (
    document.getElementById("proField") as HTMLInputElement
  ).value;

  let edField = document.getElementsByClassName(
    "edField"
  ...
  let courseField = document.getElementsByClassName(
    "courseField"
  ) as HTMLCollectionOf<HTMLInputElement>;
  let tchStr = " ";
  ...
  let skillField = document.getElementsByClassName(
    "skillField"
  ) as HTMLCollectionOf<HTMLInputElement>;
  let skillStr = " ";
  ...
  let expField = document.getElementsByClassName(
    "expField"
  ) as HTMLCollectionOf<HTMLInputElement>;
  let expStr = " ";
  ...
  (document.getElementById("resume-input") as HTMLDivElement).style.display =
    "none";
  (
    document.getElementById("resume-generated") as HTMLDivElement
  ).style.display = "block";
