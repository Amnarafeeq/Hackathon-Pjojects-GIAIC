...
function genResume(event) {
  ...
  var tchStr = " ";
  for (
    var _b = 0, courseField_1 = courseField;
    _b < courseField_1.length;
    _b++
  ) {
  ...
  editBtn.addEventListener("click", function () {
    ...
    document.getElementById("resume-generated").style.display = "none";
  });
}
